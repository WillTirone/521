...
find_kcv = function(X_train,y_train,ks=1:10,nfold=5){
  ...
  # finding optimal k 
  optimal_k = as.integer(errors[errors[,2] == min(errors[,2]),][1])
  return_values = list(optimal_k, errors)
  return(return_values)
}

result = find_kcv(train_set[, -5], train_set[, 5])
cat("Optimal K Value :", result[[1]])
```
...
Out of curiosity, trying this again with a very large k, choosing optimal k, and plotting
